...
import img1 from "../assets/vacation3.jpg";
import img2 from "../assets/vacation3.jpg";
  ...
  return (
    <div>
      ...
      >
        <div class="flex w-full mb-10">
          <div class="w-full relative">
            ...
            <p class="text-white text-center capitalize font-light text-2xl md:text-2xl py-2">Modern & Beautiful Travel Theme</p>
          </div>
        </div>
      </main>
      ...
      <div className="w-full">
        ...
        <div className="mt-20 pb-16 md:px-0 px-3">
          <div className="grid md:grid-cols-2 gap-10 md:w-[80%] mx-auto">
            <div className="border group py-5 px-2 md:px-4 md:rounded-s-full rounded-t-full">
              <img src={CeoImg} className="md:rounded-s-full rounded-t-full" />
            </div>
            <div className="py-5 px-2 md:px-4 flex justify-center items-center">
              <div className="py-2">
                ...
                <p className="text-[15px] text-center my-2 md:my-4">
                  I am committed to providing you with the highest quality
                  travel experiences, tailored to your interests and
                  preferences. Whether you're seeking adventure in the great
                  outdoors, cultural immersion in bustling cities, or relaxation
                  on pristine beaches, we have the perfect itinerary for you.
                </p>
                <p className="text-center text-xl font-semibold uppercase">
                  Mission.
                </p>
                <p className="text-[15px] text-center my-2 md:my-4">
                  ...
                  world and enrich their lives through transformative travel
                  experiences.
                </p>
              </div>
            </div>
              ...
              <div>
                ...
                <div className="md:w-[80%] md:mb-8">
                  <p className="text-[16px] text-justify text-gray-800 ">
                    At Lucidreams, we're committed to making your international
